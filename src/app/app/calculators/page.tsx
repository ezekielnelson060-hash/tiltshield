...
export default function CalculatorsPage() {
  ...
  useEffect(() => {
    ...
    if (s?.answers) {
      ...
      if (a.emergency_supply_weeks)
        setEmergencyWeeks(String(a.emergency_supply_weeks));
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 px-4 py-6 lg:px-8">
      <PageHeader
        title="Calculators"
        subtitle="Model runway and buffers. Apply when the number is real."
        backHref="/app/more"
        showBack
      />
      ...
      {tab === "runway" && (
        <ResultCard
          ...
          rows={[
            ...
            {
              k: "90-day target",
              v: `$${runway.targetSavings90.toLocaleString()}`,
            },
            {
              k: "Gap to 90 days",
              v:
                runway.gapTo90 > 0
                  ? `$${runway.gapTo90.toLocaleString()}`
                  : "On target",
            },
          ]}
        />
