        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              >
                <div>
                  <p className="text-sm font-medium text-zinc-100">In-app guides</p>
                  <p className="mt-0.5 text-[11px] text-zinc-500">
                    Step-by-step moves for your year plan
                  </p>
                </div>
              ...
              >
                <div>
                  <p className="text-sm font-medium text-zinc-100">Longform guides</p>
                  <p className="mt-0.5 text-[11px] text-zinc-500">
                    Emergency fund · bank outage · income loss · phone · food
                  </p>
                </div>
