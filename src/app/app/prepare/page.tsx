...
export default function PreparePage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5 px-4 pb-24 pt-2">
      ...
      {tab === "stock" && (
        <div className="space-y-5">
          <p className="text-sm text-zinc-400">
            Full stock checklist is restoring. Use Plan moves and Update my situation for now; score still moves when buffers change.
          </p>
          <Link href="/app/situation" className="text-sm font-medium text-emerald-400">
            Update my situation →
          </Link>
        </div>
      )}
      ...
      {tab === "journal" && (
        <div className="space-y-5">
          <p className="text-sm text-zinc-400">Journal UI is restoring. Score pulse is live on Situation and Plan.</p>
          <Link href="/app/situation" className="text-sm font-medium text-emerald-400">
            Update my situation →
          </Link>
        </div>
      ...
      {tab === "finder" && (
        <div className="space-y-5">
          <p className="text-sm text-zinc-400">Places finder is restoring.</p>
          <Link href="/app/nearby" className="text-sm font-medium text-emerald-400">
            Open Nearby →
          </Link>
        </div>
      )}
