...
import { PrepareStockTab } from "./prepare-stock-tab";
import { PrepareJournalTab } from "./prepare-journal-tab";
import { PrepareFinderTab } from "./prepare-finder-tab";
    ...
    <div className="mx-auto max-w-2xl space-y-5 px-4 pb-24 pt-2">
      ...
      {tab === "stock" && (
        <PrepareStockTab
          ...
          setStockVersion={setStockVersion}
          setChecks={setChecks}
