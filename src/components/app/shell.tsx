...
function NavIcon({ name, className }: { name: string; className?: string }) {
  ...
  switch (name) {
    ...
    case "users":
      return (
        <svg className={c} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 0v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" />
        </svg>
      );
    default:
      return (
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  if (!session) {
    return (
      <div className="tilt-app-shell flex min-h-screen items-center justify-center bg-background text-muted-foreground">
        Loading…
      </div>
    );
  }
  ...
  return (
    <>
      <IntelTopBanner />
      <div className="tilt-app-shell flex min-h-screen bg-background text-foreground">
        <aside className="tilt-app-aside sticky top-0 hidden h-screen w-[260px] shrink-0 flex-col border-r border-white/[0.06] bg-[#080d16] lg:flex">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <nav className="tilt-app-nav fixed inset-x-0 bottom-0 z-40 border-t border-white/[0.06] bg-[#080d16]/95 backdrop-blur-xl lg:hidden">
